...
import static net.glasslauncher.mods.machineutils.event.init.MachineUtilsConfig.CONFIG;
import static net.glasslauncher.mods.machineutils.event.init.MachineUtilsConfig.generalConfig;
