...
public class PlatformUtils
{
    ...
    public static boolean launchGUI(PlayerBase entityplayer, TileEntityBase tileentity, Integer integer)
    {
        if(integer == 0 && (tileentity instanceof InventoryBase))
        {
        ...
        {
            GuiHelper.INSTANCE.openGUI(entityplayer, "ic2", integer.shortValue(), (InventoryBase) tileentity, ((IHasGuiContainer) tileentity).getGuiContainer(entityplayer.inventory));
            return true;
        } else
        {
            return false;
